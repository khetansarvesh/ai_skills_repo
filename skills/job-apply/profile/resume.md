...
> The job-apply skill reads this to populate application fields.

## Personal Information

- **Full Name**: Sarvesh Nand Kumar Khetan
- **First Name**: Sarvesh
- **Last Name**: Khetan
- **Email**: skhetan@terpmail.umd.com
- **Phone**: (240) 726-8367
- **Location**: College Park, MD, USA
- **LinkedIn**: https://www.linkedin.com/in/sarveshkhetan
- **GitHub**: https://github.com/khetansarvesh
- **Portfolio/Website**: https://khetansarvesh.medium.com

## Work Authorization

- **Authorized to work in**: USA (on student visa)
- **Visa sponsorship required**: No
- **Visa type (if applicable)**: F-1 OPT / STEM OPT
...
- **Relevant Coursework**: Machine Learning (TA x2)

### Degree 2

- **University**: Birla Institute of Technology and Science (BITS) Pilani
- **Degree**: Bachelor of Technology
- **Major**: Mechanical Engineering (Minor: Data Science)
- **GPA**: 3.77 / 4.0
- **Graduation Date**: June 2022
- **Relevant Coursework**: Linear Optimization (TA)
...
- **Location**: India
- **Description**: |
  - Spearheaded a team of 5 to design a patented RAG-based Text2SQL Graph AI agent, leveraging knowledge graphs, LLMs, GNNs and Langchain, securing $1M+ in management funding for Generative AI initiatives.
...
- Top 10 rankings in UCMAS (Mental Math) Competition for two consecutive years.
- Captained district cricket team.
...
- **Earliest Start Date**: June 2026
- **How did you hear about us (default)**: Company's Career Page
- **Gender (optional)**: Male
- **Race/Ethnicity (optional)**: Asian
- **Veteran Status (optional)**: Not a protected veteran
- **Disability Status (optional)**: No

## Resume PDF Path

> Path to your resume PDF for file upload fields

- **Resume PDF**: /Users/sarveshkhetan/work/ai_skills_repo/skills/job-apply/profile/khetan,Sarvesh_full_time.pdf
- **Cover Letter Template (optional)**: /Users/sarveshkhetan/work/ai_skills_repo/skills/job-apply/profile/cover_letter.md
